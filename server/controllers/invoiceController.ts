...
export async function createInvoice(request: NextRequest) {
  try {
...
export async function getInvoices(request: NextRequest) {
  try {
    const session = await getSessionWithPermissions();
...
export async function updateInvoice(request: NextRequest) {
  try {
    const session = await getSessionWithPermissions();
...
export async function deleteInvoice(request: NextRequest) {
